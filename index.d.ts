/**
 * This file is copied from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/hls.js/index.d.ts
 * with some changes related to EME_DESTROYED event
 */
...
// NOTE added by Tubi
type K_EME_DESTROYED = 'hlsEmeDestroyed'
...
declare class Hls {
    ...
    static Events: {
        ...
        /**
         * fired when EME media key sessions are closed and media key is removed
         * data: { }
         * NOTE added by Tubi
         */
        EME_DESTROYED: K_EME_DESTROYED;
    };
    /**
     * Hls error types
     */
    ...
    // NOTE added by Tubi
    on(event: K_EME_DESTROYED, callback: (event: K_EME_DESTROYED, data: {}) => void): void;
    /**
    ...
    // NOTE added by Tubi
    once(event: K_EME_DESTROYED, callback: (event: K_EME_DESTROYED, data: {}) => void): void;
